...
public class Notice implements java.io.Serializable {
   ...
   public Notice(int notice_no, String notice_title, String notice_writer, String notice_content,
         String notice_original_filepath, String notice_rename_filepath, int notice_readcount, Date notice_date) {
      super();
   ...
   public String toString() {
      return "Notice [notice_no=" + notice_no + ", notice_title=" + notice_title + ", notice_writer=" + notice_writer
            + ", notice_content=" + notice_content + ", notice_original_filepath=" + notice_original_filepath
            + ", notice_rename_filepath=" + notice_rename_filepath + ", notice_readcount=" + notice_readcount
