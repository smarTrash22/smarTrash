...
public class T_Board implements java.io.Serializable {
	...
	public T_Board(int board_no, int trash_no, String board_content, String hashtag, int board_readcount, int board_ref,
	...
	public String toString() {
		return "T_Board [board_no=" + board_no + ", trash_no=" + trash_no + ", board_content=" + board_content
